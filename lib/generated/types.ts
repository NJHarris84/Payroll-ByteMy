...
export type Scalars = {
  ...
  payroll_cycle_type: { input: import("../graphql/types").PayrollCycleEnum; output: import("../graphql/types").PayrollCycleEnum; }
  payroll_date_type: { input: import("../graphql/types").PayrollDateTypeEnum; output: import("../graphql/types").PayrollDateTypeEnum; }
