...
export type InsertPayrollMutationVariables = Types.Exact<{
...
export function useInsertPayrollMutation(baseOptions?: Apollo.MutationHookOptions<InsertPayrollMutation, InsertPayrollMutationVariables>) {
        ...
        return Apollo.useMutation<InsertPayrollMutation, InsertPayrollMutationVariables>(InsertPayroll, options);
      }
