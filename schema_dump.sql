...
--
-- Name: idx_permission_overrides_lookup; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_permission_overrides_lookup ON public.permission_overrides USING btree (user_id, role, resource, operation);
...
--
-- Name: notes id_user; Type: FK CONSTRAINT; Schema: public; Owner: -
--
